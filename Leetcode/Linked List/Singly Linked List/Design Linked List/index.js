...
class DesignLinkedList {
  ...
  Get(index) {
    /*
            the size always has to be 1 greater than the index otherwis 
            well get a null pointer exceptyion.
        */
    if (index < 0 || index >= this.size) return -1;

    // we need to locally edit the head without it taking effect.
    let current = this.head;

    // get to specified position and set current
